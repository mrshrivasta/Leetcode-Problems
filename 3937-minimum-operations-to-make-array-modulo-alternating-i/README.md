<h2><a href="https://leetcode.com/problems/password-strength">4300. Minimum Operations to Make Array Modulo Alternating I</a></h2><h3>Medium</h3><hr><p>You are given an integer array <code>nums</code> and an integer <code>k</code>.</p>
